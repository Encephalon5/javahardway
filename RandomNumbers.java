public class RandomNumbers {
  public static void main( String[] args ) {
    ...
    //pick four random integers, each 0-100
    a = 0 + (int)(100*Math.random() );
    b = 0 + (int)(100*Math.random() );
    c = (int)(100*Math.random() );
    d = (int)(100*Math.random() );
    System.out.println( "0-100:\t" + a + "\t" + b + "\t" + c + "\t" + d);

    //pick four random integers, etc 10-20
    ...
    // display three random integers, each 2-3
    a = 2 + (int)(2*Math.random() );
    b = 2 + (int)(2*Math.random() );
    c = 2 + (int)(2*Math.random() );
    System.out.println( "2-3:\t" + a + "\t" + a + "\t" + b + "\t" + c );

    // display three random integers, each 5-10
    a = 5 + (int)(6*Math.random() );
    b = 5 + (int)(6*Math.random() );
    c = 5 + (int)(6*Math.random() );
    System.out.println( "5-6:\t" + a + "\t" + a + "\t" + b + "\t" + c);
  }
}
